          ...
          <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
            ...
            <form onSubmit={handleLogIn} className="card-body">
              ...
              <div className="form-control mt-6">
                <button className="btn hover:bg-[#FF3880] bg-[#FF3811] text-white">
                  Login
                </button>
              </div>
            </form>
            <div>
              ...
              <div className="flex justify-center items-center gap-4 my-4">
                <button>
                  ...
                  <img
                    ...
                    className="rounded-full w-[55px] h-[55px] btn btn-sm "
                    alt=""
                  />
                </button>
              ...
              <h3 className="font-medium text-center mt-4 mb-10 text-[#737373]">
                New to Car Doctor?{" "}
