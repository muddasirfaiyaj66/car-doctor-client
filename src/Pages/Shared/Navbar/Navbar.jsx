    ...
    <div>
      <div className="navbar bg-base-100 h-28 mb-5">
        <div className="navbar-start">
          ...
          <Link
            to="/"
            className="btn btn-ghost hidden lg:flex normal-case text-xl"
          >
        ...
        <div className="navbar-center ">
          <div className="flex justify-center text-center mr-12 items-center lg:hidden">
            <Link
              to="/"
              className="btn btn-ghost  lg:hidden normal-case text-xl"
            >
        ...
        <div className="navbar-end">
          <button className="btn btn-outline border-[#FF3811] hover:bg-[#FF3811] hover:text-white  text-[#FF3811]  font-bold">
            Appointment
          </button>
        </div>
      </div>
